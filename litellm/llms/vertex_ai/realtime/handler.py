...
class VertexAIRealtime(VertexLLM):
    ...
    async def async_realtime(
        ...
        try:
            ...
            location = headers.get("x-goog-vertex-location", "us-central1")
            
            access_token, _ = await self._ensure_access_token_async(
            ...
            await websocket.close(code=401, reason=f"Authentication failed: {str(e)}")
            return
